...
document.addEventListener("DOMContentLoaded", function () {
  ...
  (0, _jquery2.default)(".aside__title").click(function () {
    (0, _jquery2.default)(this).toggleClass('active');
    (0, _jquery2.default)(this).siblings().toggleClass('show');
  });

  (0, _jquery2.default)(".mobile-opener").click(function () {
    (0, _jquery2.default)('.header .nav').toggleClass('show');
  });

  (0, _jquery2.default)(".nav-close").click(function () {
    (0, _jquery2.default)('.header .nav').removeClass('show');
  });
  var offset = 50; // Смещение в пикселях

  (0, _jquery2.default)('.aside__nav a').on('click', function (e) {
    e.preventDefault(); // Отключаем стандартное поведение ссылки

    // Убираем класс active у всех пунктов
    (0, _jquery2.default)('.aside__nav li').removeClass('active');

    // Добавляем класс active на текущий пункт
    (0, _jquery2.default)(this).parent('li').addClass('active');

    // Находим блок по id из href
    var targetId = (0, _jquery2.default)(this).attr('href');
    var targetElement = (0, _jquery2.default)(targetId);

    // Скроллим к элементу с учетом смещения
    if (targetElement.length) {
      (0, _jquery2.default)('html, body').animate({
        scrollTop: targetElement.offset().top - offset
      }, 500); // Время анимации 500 мс
    }
  });
});
...
exports.default = ["dev", "crazy-time-statistics.html", "crazy-time-strategies.html", "index.html", "responsible-gambling.html", "terms-and-conditions.html"];
